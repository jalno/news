					...
					<div class="upload-zone no-file" data-can-delete="<?php echo Authorization::is_accessed('files_delete') ? 'true' : 'false'; ?>">
						...
						<div class="panel panel-white">
							<div class="panel-heading">
								...
								<span><?php echo t('news.post.files'); ?></span>
								<div class="panel-tools">
									<a class="btn btn-xs btn-link btn-add tooltips" href="#" title="<?php echo t('news.post.files.add'); ?>"><i class="fa fa-plus"></i></a>
									<a class="btn btn-xs btn-link panel-collapse collapses" href="#"></a>
								</div>
							</div>
							<div class="panel-body">
						...
						<div class="no-file">
							<i class="fa fa-cloud-upload"></i><?php echo t('news.post.files.drag&drop'); ?>
						</div>
					</div>
				</div>
			</div>
